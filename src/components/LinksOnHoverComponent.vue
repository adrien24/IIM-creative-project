        ...
        <nav class="menu">
            <div class="menu__item">
                ...
                <span class="menu__item-text">
                    <a href="https://www.behance.net/gallery/168765563/LAYLOW-TRINITY-DA" target="_blank"
                        class="menu__item-inner-text">
                        Ræsilience
                    </a>
                </span>
            </div>
            <div class="menu__item">
                ...
                <span class="menu__item-text">
                    <a href="https://www.behance.net/gallery/140514641/Laylow-Live-Visuals-(Accor-Arena-2022)"
                        class="menu__item-inner-text" target="_blank">
                        Polygon1993
                    </a>
                </span>
            </div>
            <div class="menu__item">
                ...
                <span class="menu__item-text">
                    <a href="https://genius.com/Laylow-megatron-lyrics" class="menu__item-inner-text" target="_blank">
                        GENIUS
                    </a>
                </span>
            </div>
